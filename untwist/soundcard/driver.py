""""
Abstract base class that defines the methods that a soundcard 'driver' (typically wrapping some library like pyaudio or pygame) should implement. The most appropriate available implementation should be selected and bound at module init
"""
